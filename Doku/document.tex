...
Außerdem benötigt das Python Programm noch einen \ttt{if}~ \ttt{__name__=='__main__'} Block um beim Übersetzen zu erkennen, an welcher Stelle die \ttt{main} Funktion in C++ platziert werden soll.
