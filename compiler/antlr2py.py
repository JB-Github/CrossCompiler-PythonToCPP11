...
##-----------------------------------------------------------
#Walking and Tree Conversion

def pytree(File):
    """
    Parses a python file with the antlr parser generated for grammar "py.g4" and
    returns a parsetree, which can be used for syntax translation
    """
