...
public interface pyListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterDecorator(@NotNull pyParser.DecoratorContext ctx);
	/**
	 * Exit a parse tree produced by {@link pyParser#decorator}.
	 * @param ctx the parse tree
	 */
	void exitDecorator(@NotNull pyParser.DecoratorContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code val__label__is__expr}
	 * labeled alternative in {@link pyParser#expr}.
	 * @param ctx the parse tree
	 */
	void enterVal__label__is__expr(@NotNull pyParser.Val__label__is__exprContext ctx);
	/**
	 * Exit a parse tree produced by the {@code val__label__is__expr}
	 * labeled alternative in {@link pyParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitVal__label__is__expr(@NotNull pyParser.Val__label__is__exprContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code lambda__label__is__expr}
	 * labeled alternative in {@link pyParser#expr}.
	 * @param ctx the parse tree
	 */
	void enterLambda__label__is__expr(@NotNull pyParser.Lambda__label__is__exprContext ctx);
	/**
	 * Exit a parse tree produced by the {@code lambda__label__is__expr}
	 * labeled alternative in {@link pyParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitLambda__label__is__expr(@NotNull pyParser.Lambda__label__is__exprContext ctx);
	/**
